...
\begin{figure}[!ht]
  ...
  \end{minipage}
  \caption[The CMS ECAL schematic layout]%
  {The CMS ECAL schematic layout. The left is schematic showing arrangement of
    superclusters in barrel and endcap (with preshower layers). The right is \(y-z \)
    plane quarter view of ECAL layout~\cite{image-cms-ecal-layout}.}%
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{figures/cms_muon_system.pdf}
