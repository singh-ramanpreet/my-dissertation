...
These eight generators of symmetry correspond to eight gauge vector boson gluons.
...
gauge bosons in \gls{EW} theory are all massless, if we were to add mass
...
A massless spin-1 boson can exist in two transverse polarization as,
%
\begin{equation}
  \varepsilon^{\mu}_{\pm} = \mp \frac{1}{\sqrt{2}} (0, 1, \pm i, 0)
\end{equation}

and massive vector bosons can also exist in one longitudinal polarization,
%
\begin{equation}
