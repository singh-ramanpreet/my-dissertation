...
In the first stage of selection, events are selected if there are minimum number
of objects for the analysis categories i.e.
...
After initial skimming step, first loose leptons (muons and electrons) are vetoed
